...
<Interactive>
	<Editor client:only="solid-js" staticOvertype />
</Interactive>
...
<Interactive>
	<Editor client:only="solid-js" staticOvertype staticRandomAccess />
</Interactive>
...
<Interactive>
	<Editor client:only="solid-js" staticOvertype staticRandomAccess staticOutput />
</Interactive>
...
<Interactive>
	<Editor client:only="solid-js" staticControls={false} staticOvertype staticRandomAccess staticOutput staticRtl />
</Interactive>
...
<Interactive>
	<Editor client:only="solid-js" staticControls={false} staticRandomAccess staticOutput staticRange />
</Interactive>
...
<Interactive>
	<Editor client:only="solid-js" staticControls={false} staticOvertype staticRandomAccess staticOutput staticRange staticRangeOps />
</Interactive>
...
<Interactive>
	<Editor client:only="solid-js" staticControls={false} staticRandomAccess staticRange staticRangeOps staticEqualRange />
</Interactive>
...
<Interactive>
	<Editor client:only="solid-js" staticControls={false} staticOvertype staticRandomAccess staticOutput staticRtl staticRange staticRangeOps staticEqualRange />
</Interactive>
